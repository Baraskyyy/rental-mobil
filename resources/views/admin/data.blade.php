  ...
  @section('content')
    ...
    <div id="modal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center hidden z-50">
      <div class="modal bg-white dark:bg-black-800 p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h2 class="text-xl font-semibold text-black dark:text-gray-100 mb-4">Tambah Mobil Baru</h2>
        ...
        <form action="{{ route('tambah_data.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
          ...
          <div>
            <label for="gambar" class="block text-sm font-medium text-black dark:text-gray-200">Gambar Mobil</label>
